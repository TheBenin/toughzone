package org.flixel
{
	...
	public class FlxPreloader extends MovieClip
	{
		...
		protected function create():void
		{
			...
			_buffer.addChild(b);*/
			_bmpBar = new Bitmap(new BitmapData(1,7,false,0xfec23a));
			_bmpBar.x = 4;
			_bmpBar.y = _height-11;
			_buffer.addChild(_bmpBar);
			_text = new TextField();
			_text.defaultTextFormat = new TextFormat("system",8,0xfec23a);
			...
			var _textFlx:TextField = new TextField();
			_textFlx.defaultTextFormat = new TextFormat("system", 8, 0xfec23a);
			_textFlx.text = "";
			_textFlx.embedFonts = true;
			_textFlx.selectable = false;
			_textFlx.multiline = false;
			_textFlx.x = _width - 95;
			_textFlx.y = _bmpBar.y - 11;
			_textFlx.width = 95;
			_buffer.addChild(_textFlx);
			/*_logo = new ImgLogo();
			_logo.scaleX = _logo.scaleY = _height/16;
		...
		protected function update(Percent:Number):void
		{
			...
			_text.text = "Tough Zone is " +FlxU.floor(Percent * 100) + "% loaded";
