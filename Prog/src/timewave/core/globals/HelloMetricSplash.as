package timewave.core.globals 
{
	...
	{
		[Embed(source = '../../../../../Art/Release/metricas.png')] public static var imgBackground:Class;
		private var background:FlxSprite = new FlxSprite(0, 0, imgBackground);
		
		private var stars:Array = new Array;
		[Embed(source = '../../../../../Art/Release/HUD/Estrela_ON.png')] public static var imgEstrelaON:Class;
		[Embed(source = '../../../../../Art/Release/HUD/Estrela_OFF.png')] public static var imgEstrelaOFF:Class;
		[Embed(source = '../../../../../Art/Release/HUD/Estrela_OVER.png')] public static var imgEstrelaOVER:Class;
		
		private var btnOK:TWFlxButton = new TWFlxButton(0, 0, sendRatingAndExit, "Click to send your rating!");
		[Embed(source = '../../../../../Art/Release/HUD/OK_ON.png')] public static var imgBtnON:Class;
		[Embed(source = '../../../../../Art/Release/HUD/OK_OFF.png')] public static var imgBtnOFF:Class;
		[Embed(source = '../../../../../Art/Release/HUD/OK_OVER.png')] public static var imgBtnOVER:Class;
		...
		public function HelloMetricSplash() 
		{
			...
			//	ultimo ajuste para o background
			...
			for (var i:uint = 0; i < stars.length; i++)
			{
				...
				(stars[i] as TWFlxButton).scrollFactor.y = 0;
				(stars[i] as TWFlxButton).scrollFactor.x = 0;
			}
			...
			btnOK.scrollFactor.x = 0;
			btnOK.scrollFactor.y = 0;
		...
		{
			Log.LevelRangedMetric("Ratings", TopLevel.SWFStats_thisStateTag(), lastClickedStar);
			this.killMembers();
			this.kill();
			//this.active = false;
		}
